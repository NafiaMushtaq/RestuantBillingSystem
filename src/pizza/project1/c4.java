...
public class c4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DEAL 4 OPTION");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(120, 190, 287, 44);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("CHOOSE YOUR FLAVOUR");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(120, 250, 452, 44);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("CHOOSE YOUR SOFT DRINK");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(120, 360, 508, 44);
        ...
        jLabel6.setText("EXTRA TTOPPING ON JUMBO PIZZA");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(130, 480, 710, 44);
        ...
        jRadioButton2.setBounds(880, 540, 200, 53);

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Rs:249");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(1090, 480, 140, 44);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Rs:179");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(1090, 550, 140, 44);

        jRadioButton1.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jRadioButton1.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton1.setText("Cheese");
        jPanel1.add(jRadioButton1);
        jRadioButton1.setBounds(880, 470, 200, 53);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        order ="your order is: 16 inch jumbo pizza & 1.5 litre soft drink\n"; 
        order="DEAL 4 OPTION\n";
